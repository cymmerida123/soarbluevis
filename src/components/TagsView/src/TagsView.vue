...
<template>
    ...
    >
                ...
                <div class="flex h-full">
                    <ContextMenu
                        ...
                        :schema="[
                            ...
                            {
                                divided: true,
                                icon: 'svg-icon:vertical-right-outlined',
                            ...
                            {
                                icon: 'svg-icon:vertical-left-outlined',
        ...
        >
            ...
            >
                <Icon
                    icon="svg-icon:setting-outlined"
                    color="var(--el-text-color-placeholder)"
                    :hover-color="isDark ? '#fff' : 'var(--el-color-black)'"
                />
            </span>
